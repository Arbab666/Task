...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('orders', function (Blueprint $table) {
            ...
            // I replaced the float data type for commission_rate with decimal. Using decimal is generally recommended for representing fixed-point numbers (e.g., currency) to avoid precision issues that can occur with floating-point numbers
